...
function get_sum_group_count_yes(lines){
    ...
    lines.forEach(function(line) {  // for each people
        ...
        if(line === "") {
            values = Object.keys(group_count).map(function(key){
                return group_count[key];
            });  // get the values of group_count in an array
            group_yes.push(values.reduce(function(a, b) { return a + b; }, 0));  // sum the values of yes and add it to the final group to count yes
...
describe('Day 6', function() {
    it('GroupYesPart1', function() {
        var lines = input.split("\n"); // get lines
        var res = get_sum_group_count_yes(lines); // process
        console.log(res);
