...
class MarbleGame:
    ...
    def next_player(self):
        if (self.num_turn_player + 1) % self.number_players == 0:
            self.nb_tour += 1
    ...
    def increment_current_location_marble(self):
        ...
        self.current_location_marble = (self.current_location_marble + 1) % len(self.marbles)
    ...
    def get_highest_score(self):
        ...
        for player in self.players:
            ...
            if highest_score < player_score:
                ...
                num_player = player.get_numero()
        return num_player, highest_score
...
def day_9_part_2(text):
    ...
    # data visualisation
    num_player, highest_score = marble_game.get_highest_score()
    return "[" + str(num_player) + "] " + str(highest_score) + " " + str(marble_game.nb_tour)
